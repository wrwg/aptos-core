...
use aptos_metrics::{register_histogram, register_histogram_vec, DurationHistogram, HistogramVec};
...
pub static OP_COUNTERS: Lazy<aptos_metrics::OpMetrics> =
    Lazy::new(|| aptos_metrics::OpMetrics::new_and_registered("quorum_store"));
