...
use crate::{
    ...
    MempoolEventsReceiver, QuorumStoreRequest, TxnNotificationRequest,
};
...
pub(crate) async fn coordinator<V>(
    ...
    mut txn_notification_requests: mpsc::Receiver<TxnNotificationRequest>,
    ...
    V: TransactionValidation,
{
    ...
    loop {
        ...
        ::futures::select! {
            ...
            msg = txn_notification_requests.select_next_some() => {
                tasks::process_txn_notification_request(&smp, msg);
            },
            // TODO: from state sync; does this need some fixing up?
